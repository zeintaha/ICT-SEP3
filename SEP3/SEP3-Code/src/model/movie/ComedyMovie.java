...
public class ComedyMovie extends AbstractMovie implements Serializable
{
   ...
   public ComedyMovie(String name, String director, String description, String duration, String urlTrailer,
...
public String toString() {
	return "ComedyMovie [getName()=" + getName() + ", getDirector()=" + getDirector() + ", getDescription()="
