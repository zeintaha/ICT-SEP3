...
@Entity
public class AdventureMovie extends Movie implements Serializable
{
   ...
   public AdventureMovie(String title, String director, String description, String duration, String urlTrailer,
